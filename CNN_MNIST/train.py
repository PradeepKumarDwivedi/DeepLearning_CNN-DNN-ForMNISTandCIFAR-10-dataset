...
w2 = w1-FILTER_SIZE+1
print('Came till this 1')
theta3 = initialize_theta(NUM_OUTPUT, int((w2/2)*(w2/2)*NUM_FILT2)) #int added here casting float can't be treated as int
print('Came till this 2')
...
plt.savefig('CostFunctionPlotCNNMIST4th.png')
